        ...
        text-green-700 rounded-lg hover:bg-green-200 transition-colors '>
            ...
            {data.length === 0 ? (
                <div className='text-center py-8 text-gray-500'>
                    ...
                    <p className='text-sm'>"Add Experience" to get started</p>
                </div>
            ) : (
                    ...
                    {data.map((experience, index) => (
                        <div key={index} className='p-4 border border-gray-200 rounded-lg space-y-3'>
                            ...
                            <label className='flex items-center gap-2' >
                                ...
                                <span className='text-sm text-gray-900'>Currently working here</span>
                            </label>
                            ...
                            <div className='space-y-2'>
                                ...
                                <textarea onChange={(e) => updateExperience(index, "description", e.target.value)}
                                    value={experience.description || ""} rows={4}
