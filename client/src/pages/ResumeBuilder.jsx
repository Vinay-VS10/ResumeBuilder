            ...
            <div className='relative w-full'>
              <div className='absolute bottom-3 left-0 right-0 flex items-center justify-end gap-2'>
                {resumeData.public && (
                  ...
                  from-blue-100 to-blue-200 text-blue-600 ring-blue-300 hover:ring transition-colors'>
                ...
                <button onClick={downloadResume}
                 className='flex items-center  px-6 py-2 gap-2 text-xs bg-gradient-to-br
