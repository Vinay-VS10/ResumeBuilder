    ...
    try {
        ...
        const response = await ai.chat.completions.create({
            ...
            messages: [
                {
                    role: "system",
                    content: "Your task is to enhance the professional summary of a resume."
                },
                {
                    role: "user",
                    content: userContent,
    ...
    try {
        ...
        const response = await ai.chat.completions.create({
            ...
            messages: [
                {
                    role: "system",
                    content: "Your task is to enhance the job description of a resume."
                },
                {
                    role: "user",
                    content: userContent,
    ...
    try {
        ...
        const response = await ai.chat.completions.create({
            ...
            messages: [
                {
                    role: "system",
                    content: "Your task is to enhance the project description of a resume. Return only the improved paragraph without any explanation."
                },
                {
                    role: "user",
                    content: userContent,
